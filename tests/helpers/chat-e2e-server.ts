...
export type ChatE2EHarness = {
  ...
  close: () => Promise<void>;
  useCase: ReturnType<typeof buildUseCase>["useCase"];
};
...
export async function createChatE2EHarness(): Promise<ChatE2EHarness> {
  ...
  v1Router.get("/groups/:groupId/polls/:pollId", auth, httpService.getPollAPI.bind(httpService));
  ...
  v1Router.delete("/groups/:groupId/polls/:pollId", auth, httpService.deletePollAPI.bind(httpService));
  ...
  return {
    ...
    useCase: useCase as ReturnType<typeof buildUseCase>["useCase"],
