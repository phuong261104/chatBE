...
Purpose: protect core chat v2 business rules at usecase level with mocked repositories.

Business flows:
- Edit can be bounded by a 30 second window when v2 passes that limit.
