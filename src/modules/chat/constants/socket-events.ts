export const SocketEvent = {
  ...
  POLL_NEW: "poll:new",
  POLL_VOTE: "poll:vote",
  POLL_OPTION_ADDED: "poll:option_added",
  ...
  GROUP_REMINDER_PINNED: "group:reminder_pinned",
  GROUP_REMINDER_UNPINNED: "group:reminder_unpinned",
  GROUP_REMINDER_DUE: "group:reminder_due",
  ...
  PIN_REMINDER: "pinReminder",
  UNPIN_REMINDER: "unpinReminder",
